...
@HiltViewModel
class HealthDataViewModel @Inject constructor(private val healthConnectManager: HealthConnectManager) : ViewModel() {
    ...
    private fun getStepsHealthData() {
        ...
        healthConnectManager.readStepsByTimeRange(
            ...
            _healthDataState.update { state ->
                state.copy(
                    stepsData = state.stepsData.copy(loading = false,
